...
namespace Jellyfin.Plugin.JavScraper.Extensions
{
    ...
    /// </summary>
    public static class FileExtensionContentTypeProvider
    {
        /// <summary>
        ...
        public static bool TryGetContentType(string subpath, [NotNullWhen(true)] out string? contentType)
        {
            contentType = null;
            return TryGetExtension(subpath, out var extension) && _mappings.TryGetValue(extension, out contentType);
        }

        private static bool TryGetExtension(string path, [NotNullWhen(true)] out string? extension)
        {
