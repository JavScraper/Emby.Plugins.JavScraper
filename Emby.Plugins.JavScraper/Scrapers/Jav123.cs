...
namespace Emby.Plugins.JavScraper.Scrapers
{
    ...
    public class Jav123 : AbstractScraper
    {
        ...
        public Jav123(HttpClientHandler handler = null, ILogger log = null)
            : base("https://www.jav321.com/", handler ?? new JsProxyHttpClientHandler(), log)
        {
        }
        ...
        public override bool CheckKey(string key)
            => Plugin.Instance?.Configuration?.IsSuren(key) != true && JavIdRecognizer.FC2(key) == null;
